...
public class FluidApiActual {
    ...
    @Actual
    public static final EntityLookup<CommonStorage<FluidResource>, Direction> ENTITY = EntityLookup.createAutomation(new ResourceLocation(Botarium.MOD_ID, "entity_fluid"), CommonStorage.asClass());
}
