...
public record WrappedBlockItemContainer<T extends ItemContainer & Serializable>(T container, Level level, BlockPos blockPos, BlockState state) implements ItemContainer, Serializable, Updatable {
